...
// УЛЬТРА-СКОРОСТНОЙ ИГРОВОЙ ЦИКЛ (Фикс рассинхрона)
function animateCursor() {
    /* Коэффициент 0.85 гарантирует мгновенный отклик: кольцо прилетает на кнопку 
       одновременно с физическим наведением мыши, полностью исключая задержку */
