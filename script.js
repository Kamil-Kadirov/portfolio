...
// УЛЬТРА-РЕАКТИВНЫЙ ДВИЖОК: Коэффициент 0.96 делает отставание неощутимым
function animateCursor() {
    /* 0.96 убирает видимую глазу плавность перемещения. Кольцо прилипает к мышке 
       и залетает на кнопки мгновенно, полностью убирая рассинхрон с ховерами */
    cursorX += (mouseX - cursorX) * 0.96; 
    cursorY += (mouseY - cursorY) * 0.96;
